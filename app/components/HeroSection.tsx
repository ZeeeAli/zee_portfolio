			...
			<div className="container mx-auto px-4 z-10">
				<div className="text-center mb-8">
					...
					<p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed px-4">
						...
						<span className="text-blue-400"> React JS</span>,<span className="text-purple-400"> TailwindCSS</span>, and
						...
						<div className="bg-gradient-to-b from-gray-900 to-gray-800 rounded-2xl overflow-hidden relative">
							...
							<div className="relative p-8">
								...
								<div className="text-center mt-6">
									...
									<p className="text-gray-400 mb-6 group-hover:text-gray-300 transition-colors">Rent Your Dream Car Today</p>
									...
									<div className="grid grid-cols-3 gap-4 mb-6">
										...
										<div className="space-y-1">
											<div className="flex items-center justify-center gap-1 text-blue-400">
												...
												<FaCss3Alt className="w-5 h-5" aria-label="TailwindCSS icon" />
										...
										<div className="space-y-1">
											<div className="flex items-center justify-center gap-1 text-green-400">
												...
												<SiTypescript className="w-5 h-5" aria-label="TypeScript icon" />
