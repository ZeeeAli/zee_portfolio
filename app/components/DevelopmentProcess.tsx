...
const processes: Process[] = [
	...
	},
	{
		...
		steps: ['Project Setup and Tech Stack Selection', 'Agile Development with Component-Driven Sprints', 'Continuous Testing'],
	},
	{
		title: 'Launch & Growth',
		colorClasses: {
		...
		steps: ['SEO Optimization and Deployment', 'Analytics Integration and Performance Monitoring', 'Updates and UI Enhancements'],
	},
];
